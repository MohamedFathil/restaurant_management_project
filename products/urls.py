...
from .views import ItemView, MenuItemView, menu_page, MenuCategoryView, MenuItemByCategoryView, MenuItemUpdateView, MenuItemSearchView  
...
urlpatterns = [
    ...
    path('search/', MenuItemSearchView.as_view(), name="search"),
    # template page
